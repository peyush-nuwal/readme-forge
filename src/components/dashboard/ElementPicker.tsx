...
const ElementPicker = () => {
  ...
  return (
    <div className="col-span-24 sm:col-span-10 lg:col-span-5  h-full p-4  bg-white dark:bg-neutral-800 border border-stone-300 dark:border-stone-800 rounded-xl shadow-sm overflow-y-auto overflow-x-hidden no-scrollbar">
      {/* ---header --- */}
